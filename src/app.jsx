    ...
    const runLiveScan = async (region) => {
        ...
        try {
            ...
            if (result.degraded) {
                ...
                addLog(
                    `„${meta.label}“: ${hasSources
                        ? 'KI-Auswertung nicht möglich (Zeitlimit oder Gateway) – Baseline-Lagebericht auf Basis der abgerufenen Quellen.'
                        : 'Die Nachrichten-Feeds waren nicht erreichbar – Baseline-Lagebericht ohne aktuelle Quellen.'}`,
                    "warning"
                );
            }
